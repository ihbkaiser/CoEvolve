...
class Alignment(PydanticBaseModel):
    alignment_score: float = Field(..., ge=0.0, le=1.0, description="Alignment score between plan and code")
...
class VerificationOutput(PydanticBaseModel):
    ...
    alignment_score: float = Field(default=0.0, ge=0.0, le=1.0, description="Alignment score for verification")
    coherence_explanation: str = Field(default="No explanation provided", description="Coherence explanation for verification")
    coherence_score: float = Field(default=0.0, ge=0.0, le=1.0, description="Coherence score for verification")
    overall_solvability: int = Field(default=0, ge=0, le=100, description="Overall solvability score")
